...
saveRDS(gapminder_data, "data/tidy_gapminder_data.rds")
...
![Using SQL to order the gapminder data by life expectancy](data/images/SQL_example_gapminder.png)
...
![Using SQL to select only the cases in France in the flu data ](data/images/SQL_example_flu.png)
...
![Using SQL to sort dengue by cases](data/images/SQL_example_dengue.png)
